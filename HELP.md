...
Ориентир по ui - сайт авиакомпании. Предложения - поощраются
...
<ul>
<li>Backenf/Frontend - задача для бэкенда или фронтенда</li>
<li>Feature/Refactor - новый функционал или переработка существующего</li>
<li>Bug - таска на исправление бага до или после тестирования</li>
<li>Reworking - таска на исправлении замечаний после кросс или файнал ревью</li>
<li>InQA - задача с такой меткой находится у тестировщика в работе </li>
<li>Backlog, ToDo, InProgress, CrossReview, FinalReview - этапы прохождения задачи по борде</li>
</ul>
